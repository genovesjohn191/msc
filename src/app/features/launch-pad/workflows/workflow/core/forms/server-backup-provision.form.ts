...
import {
  backupProvisionAddOnFormConfig,
  backupProvisionFormConfig
} from './shared/backup-provision.form.config';
import { standardContextMapper } from './shared/standard-context-mapper';

export const serverBackupProvisionForm: LaunchPadForm = {
...
export const serverBackupProvisionAddOnForm: LaunchPadForm = {
  config: backupProvisionAddOnFormConfig,
