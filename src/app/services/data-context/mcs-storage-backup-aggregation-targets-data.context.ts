...
export class McsStorageBackupAggregationTargetsDataContext implements McsDataContext<McsStorageBackUpAggregationTarget> {
   ...
   */
  public getAllRecords(): Observable<McsStorageBackUpAggregationTarget[]> {
   ...
   */
  public getRecordById(id: string): Observable<McsStorageBackUpAggregationTarget> {
   ...
   */
  public filterRecords(query: McsQueryParam): Observable<McsStorageBackUpAggregationTarget[]> {
