...
export class McsReportBillingAvdDailyUsersParam extends McsQueryParam {
  ...
  @JsonProperty({ name: 'date_range_after' })
  public dateRangeAfter: string = undefined;

  @JsonProperty({ name: 'date_range_before' })
  public dateRangeBefore: string = undefined;
