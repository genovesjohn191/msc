...
import { DynamicSelectChipsReservedInstanceTypeField } from './select-chips-reserved-instance-type';
import {
...
@Component({
  selector: 'mcs-dff-select-chips-reserved-instance-type-field',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => DynamicSelectChipsReservedInstanceTypeComponent),
      multi: true
    }
  ],
  host: {
...
export class DynamicSelectChipsReservedInstanceTypeComponent extends DynamicSelectChipsFieldComponentBase<McsTerraformTag> {
  @ViewChild('valueInput') valueInput: ElementRef<HTMLInputElement>;
  @ViewChild('auto') matAutocomplete: MatAutocomplete;

  public config: DynamicSelectChipsReservedInstanceTypeField;
