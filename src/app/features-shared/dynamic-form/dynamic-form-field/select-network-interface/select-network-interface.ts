...
export class DynamicSelectNetworkInterfaceField extends DynamicFormFieldConfigBase {
  // Overrides
  public type: DynamicFormFieldType = 'select-network-interface';
  public template: DynamicFormFieldTemplate = 'select-network-interface';
  public value?: any;//networkInterface[];
