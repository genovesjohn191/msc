...
@Component({
  selector: 'mcs-avd-daily-connections-widget',
  templateUrl: './avd-daily-connections-widget.component.html',
...
export class AvdDailyConnectionsWidgetComponent extends ReportWidgetBase implements OnInit, OnChanges, OnDestroy {
  @Input()
  ...
  public initializeDataRecords(): void {
    ...
    this._serviceOperation = BillingOperationFactory
      ...
      .createServiceGroupFactory(BillingOperationType.DailyConnectionService, this.dataRecords);
