...
import { ServerManagedScaleSelectedEvent } from './events/server-scale-manage-selected.event';
...
import { JobServerManagedScaleEvent } from './events/job-server-managed-scale.event';
import { JobServerManagedRaiseInviewLevelEvent } from './events/job-server-managed-raise-inview-level.event';
